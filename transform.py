...
hydropower_file = "Data-hien/du_lieu_thuy_dien.xlsx"
weather_file = "Data-hien/thoi_tiet_hien_tai.xlsx"
vitri_file="Data-hien/vi-tri.xlsx"
song_file= "Data-hien/ten_song_vietnam.xlsx"
loaithientai_file="Data-hien/loai_thien_tai.xlsx"
lstt_file="Data-hien/lich_su_thoi_tiet.xlsx"
khdieutiet_file="Data-hien/ke_hoach_dieu_tiet_nuoc.xlsx"
dlthuydien_file="Data-hien/du_lieu_thuy_dien.xlsx"
dlnuoc_file="Data-hien/du_lieu_nuoc_tren_song.xlsx"
dlnuoc_file="Data-hien/du_lieu_nuoc_tren_song.xlsx"
dieutietnuoc_file="Data-hien/dieu_tiet_nuoc_thuy_dien.xlsx"
event_file="Data-hien/du_lieu_thien_tai.xlsx"
# Thông tin về bảng BigQuery
project_id = "dean2-442908"
dataset_id = "dean2-442908.DataWareHouse"
...
def transform_hydropower_data(df):
    try:
        return pd.DataFrame({
            ...
            "Tram_thuy_dien_ID": df["ID"].astype(str),
            "Thoi_gian_hoat_dong": pd.to_datetime(df["Năm hoạt động"], errors='coerce').dt.date,
            "San_luong_dien": df["Sản lượng (triệu KWh/năm)"].astype(float),
            "Cong_suat_phat_dien": df["Công suất PLM (MW)"].astype(float),
        })
    except Exception as e:
